...
> 蚂蚁系统有三种基本模型分别是蚁周模型、蚁密模型、蚁量模型。三种模型的实现大致相同,主要区别是在信息素
>
> 的更新方式上。
...
![image-20210607213502978](../../assets/image-20210607213502978.png)
...
![image-20210607213716906](../../assets/image-20210607213716906.png)
